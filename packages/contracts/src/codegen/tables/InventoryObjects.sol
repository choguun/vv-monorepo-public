...
library InventoryObjects {
  // Hex below is the result of `WorldResourceIdLib.encode({ namespace: "", name: "InventoryObjects", typeId: RESOURCE_TABLE });`
  ResourceId constant _tableId = ResourceId.wrap(0x74620000000000000000000000000000496e76656e746f72794f626a65637473);
  ...
  ) internal view returns (uint16[] memory objectTypeIds) {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = ownerEntityId;
   ...
   * @notice Get objectTypeIds (using the specified store).
   */
  function get(IStore _store, bytes32 ownerEntityId) internal view returns (uint16[] memory objectTypeIds) {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = ownerEntityId;
   ...
   */
  function setObjectTypeIds(IStore _store, bytes32 ownerEntityId, uint16[] memory objectTypeIds) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = ownerEntityId;
   ...
   * @notice Set objectTypeIds (using the specified store).
   */
  function set(IStore _store, bytes32 ownerEntityId, uint16[] memory objectTypeIds) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = ownerEntityId;
   ...
   */
  function lengthObjectTypeIds(bytes32 ownerEntityId) internal view returns (uint256) {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = ownerEntityId;
   ...
   * @notice Get the length of objectTypeIds.
   */
  function _lengthObjectTypeIds(bytes32 ownerEntityId) internal view returns (uint256) {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = ownerEntityId;
   ...
   * @dev Reverts with Store_IndexOutOfBounds if `_index` is out of bounds for the array.
   */
  function getItemObjectTypeIds(IStore _store, bytes32 ownerEntityId, uint256 _index) internal view returns (uint16) {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = ownerEntityId;
   ...
   * @dev Reverts with Store_IndexOutOfBounds if `_index` is out of bounds for the array.
   */
  function getItem(IStore _store, bytes32 ownerEntityId, uint256 _index) internal view returns (uint16) {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = ownerEntityId;
   ...
   */
  function pushObjectTypeIds(IStore _store, bytes32 ownerEntityId, uint16 _element) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = ownerEntityId;
   ...
   * @notice Push an element to objectTypeIds (using the specified store).
   */
  function push(IStore _store, bytes32 ownerEntityId, uint16 _element) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = ownerEntityId;
   ...
   */
  function popObjectTypeIds(bytes32 ownerEntityId) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = ownerEntityId;
   ...
   * @notice Pop an element from objectTypeIds.
   */
  function _popObjectTypeIds(bytes32 ownerEntityId) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = ownerEntityId;
   ...
   */
  function updateObjectTypeIds(IStore _store, bytes32 ownerEntityId, uint256 _index, uint16 _element) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = ownerEntityId;
   ...
   * @notice Update an element of objectTypeIds (using the specified store) at `_index`.
   */
  function update(IStore _store, bytes32 ownerEntityId, uint256 _index, uint16 _element) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = ownerEntityId;
