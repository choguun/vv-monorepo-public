...
library Character {
   ...
   * @notice Get value.
   */
  function getValue(address playerAddress) internal view returns (CharacterTypes value) {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32(uint256(uint160(playerAddress)));

    bytes32 _blob = StoreSwitch.getStaticField(_tableId, _keyTuple, 0, _fieldLayout);
    return CharacterTypes(uint8(bytes1(_blob)));
  }

  /**
   * @notice Get value.
   */
  function _getValue(address playerAddress) internal view returns (CharacterTypes value) {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32(uint256(uint160(playerAddress)));
   ...
   * @notice Get value.
   */
  function get(address playerAddress) internal view returns (CharacterTypes value) {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32(uint256(uint160(playerAddress)));
   ...
   * @notice Get value.
   */
  function _get(address playerAddress) internal view returns (CharacterTypes value) {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32(uint256(uint160(playerAddress)));
   ...
   * @notice Set value.
   */
  function setValue(address playerAddress, CharacterTypes value) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32(uint256(uint160(playerAddress)));
   ...
   * @notice Set value.
   */
  function _setValue(address playerAddress, CharacterTypes value) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32(uint256(uint160(playerAddress)));
   ...
   * @notice Set value.
   */
  function set(address playerAddress, CharacterTypes value) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32(uint256(uint160(playerAddress)));
   ...
   * @notice Set value.
   */
  function _set(address playerAddress, CharacterTypes value) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32(uint256(uint160(playerAddress)));
   ...
   */
  function encodeStatic(CharacterTypes value) internal pure returns (bytes memory) {
   ...
   */
  function encode(CharacterTypes value) internal pure returns (bytes memory, EncodedLengths, bytes memory) {
